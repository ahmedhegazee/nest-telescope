...
export class Week8MLAnalyticsController {
  ...
  @ApiQuery({ name: 'type', required: false, enum: ['performance', 'error', 'traffic', 'resource', 'query'] })
  ...
  @ApiQuery({ name: 'type', required: false, enum: ['index', 'rewrite', 'cache', 'partition', 'normalize'] })
  ...
  @ApiQuery({ name: 'component', required: false, type: String })
  @ApiQuery({ name: 'predictionType', required: false, enum: ['load', 'failure', 'performance', 'resource'] })
  ...
  @ApiQuery({ name: 'type', required: false, enum: ['anomaly', 'regression', 'prediction', 'optimization'] })
  @ApiQuery({ name: 'limit', required: false, type: Number })
